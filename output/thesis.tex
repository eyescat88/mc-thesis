...
processo civile''\footnote{M. D'ALBERTI, \emph{Diritto amministrativo
  comparato}, cit., 76. àò}.} Il ricorso per l'ottemperanza va proposto
...
l'eventuale prova del passaggio in giudicato\footnote{Cfr.
...
mancanza di una netta divisione tra il potere esecutivo e il giudiziario
ha rappresentato un terreno fertile per organi di questo tipo, mentre
nei ``paesi a diritto amministrativo'', in cui tale separazione vi è
stata, ciò non è avvenuto\footnote{Avanzando un parallelo con
  l'ordinamento italiano, nel Regno Unito è in pratica mancato un
  provvedimento normativo simile alla legge 31 marzo 1889, n.~5992, che
  ha istituito un sistema di giudici speciali per l'amministrazione.
  Cfr. M. D'ALBERTI, \emph{Diritto amministrativo comparato}, cit., 64.}.
...
anche di conflitti che intervengono fra i privati, dipende anche dal
fatto che comportano costi inferiori rispetto a quelli dei rimedi
giurisdizionali e decidono più speditamente. Essi non agiscono nelle
forme del procedimento, ma in quelle del processo, poiché esercitano
\emph{quasi-judicial functions}, ossia funzioni che non sono giudiziarie
in senso stretto, ma che vanno esercitate sotto molti aspetti
...
law} costruita dalle corti giudiziarie\footnote{M. D'ALBERTI,
  \emph{Diritto amministrativo comparato}, cit., 76. àò}.
